...
public class AUTO_AccelTuningF extends SequentialCommandGroup{
    public AUTO_AccelTuningF(SUB_Drivetrain p_drivetrain, SUB_Pivot p_pivot, SUB_FlippyWrist p_flippyWrist, SUB_Elevator p_elevator, SUB_Intake p_intake, SUB_Algae p_algae){
        addCommands(
