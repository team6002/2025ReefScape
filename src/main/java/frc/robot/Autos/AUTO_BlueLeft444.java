...
public class AUTO_BlueLeft444 extends SequentialCommandGroup{
    public AUTO_BlueLeft444(SUB_Drivetrain p_drivetrain, SUB_Pivot p_pivot, SUB_Wrist p_wrist, SUB_Elevator p_elevator, SUB_CoralHolder p_intake, SUB_Algae p_algae, SUB_Vision p_vision){
        addCommands(
