...
public class AUTO_AccelTuning extends SequentialCommandGroup{
    public AUTO_AccelTuning(SUB_Drivetrain p_drivetrain, SUB_Pivot p_pivot, SUB_Wrist p_wrist, SUB_Elevator p_elevator, SUB_CoralHolder p_intake, SUB_Algae p_algae){
        addCommands(
