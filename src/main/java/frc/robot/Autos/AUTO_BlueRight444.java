...
public class AUTO_BlueRight444 extends SequentialCommandGroup{
    public AUTO_BlueRight444(SUB_Drivetrain p_drivetrain, SUB_Pivot p_pivot, SUB_FlippyWrist p_flippyWrist, SUB_Elevator p_elevator, SUB_Intake p_intake, SUB_Vision p_vision){
        addCommands(
