...
public class CMD_AlgaeIntakeLevelThree extends Command{
    ...
    public CMD_AlgaeIntakeLevelThree(SUB_Pivot p_pivot, SUB_Elevator p_elevator, SUB_Wrist p_wrist, SUB_Algae p_algae, GlobalVariables p_variables){
        m_pivot = p_pivot;
    ...
    public void execute(){
        if(!setWrist){
            setWrist = true;
            m_wrist.setGoal(WristConstants.kReadyAlgael3);
        }
