...
public class CMD_Score extends Command{
    ...
    public CMD_Score(SUB_Elevator p_elevator, SUB_Arm p_arm, SUB_CoralHolder p_coralHolder, SUB_ElevatorPivot p_elevatorPivot, 
    ...
    public void initialize(){
        switch(m_variables.getRobotState()){
           case HOME:
                new CMD_ReadyToIntake(m_elevator, m_coralHolder, m_arm, m_elevatorPivot).schedule();
                m_variables.setRobotState(RobotState.READY_TO_INTAKE);
                break;
            case READY_TO_INTAKE:
                new CMD_Stow(m_elevator, m_coralHolder, m_arm, m_elevatorPivot).schedule();
                m_variables.setRobotState(RobotState.STOW);
                break;
           case STOW:
                new CMD_ReadyToDeploy(m_elevator, m_coralHolder, m_arm, m_elevatorPivot).schedule();
            ...
            case READY_TO_DEPLOY:
                ...
                break;
            case DEPLOY:
                new CMD_Home(m_elevator, m_coralHolder, m_arm, m_elevatorPivot).schedule();
