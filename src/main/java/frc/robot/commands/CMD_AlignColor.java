...
public class CMD_AlignColor extends Command{
...
//This only uses Odometry to align itself
  public CMD_AlignColor(SUB_Drivetrain p_drivetrain, SUB_Vision p_vision, CommandXboxController p_driverController) {
