...
public class CMD_ChangeLevelTwo extends Command{
    ...
    public CMD_ChangeLevelTwo(SUB_Elevator p_elevator, SUB_FlippyWrist p_flippyWrist, SUB_Pivot p_pivot, GlobalVariables p_variables){
    ...
    public void initialize(){
        ...
        setElevator = false;
        setPivot = false;
        if(GlobalVariables.m_placeFront) m_flippyWrist.setGoal(FlippyWristConstants.kDeployFrontL2);
        else m_flippyWrist.setGoal(FlippyWristConstants.kDeployFrontL2);
    }
