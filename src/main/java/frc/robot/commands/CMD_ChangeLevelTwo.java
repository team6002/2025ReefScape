...
public class CMD_ChangeLevelTwo extends Command{
    ...
    public CMD_ChangeLevelTwo(SUB_Elevator p_elevator, SUB_FlippyWrist p_flippyWrist, SUB_SpinnyWrist p_spinnyWrist,  SUB_Pivot p_pivot, GlobalVariables p_variables){
