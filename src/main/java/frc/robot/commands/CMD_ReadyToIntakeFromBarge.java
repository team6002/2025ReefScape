...
public class CMD_ReadyToIntakeFromBarge extends SequentialCommandGroup{
    public CMD_ReadyToIntakeFromBarge(SUB_Elevator p_elevator, SUB_Wrist p_wrist, SUB_Pivot p_pivot, SUB_CoralHolder p_intake){
        addCommands(
