...
public class CMD_ReadyToDeployLevelFour extends SequentialCommandGroup{
    public CMD_ReadyToDeployLevelFour(SUB_Elevator p_elevator, SUB_Wrist p_wrist, SUB_Pivot p_pivot){
        addCommands(
            new InstantCommand(()-> p_wrist.setConstraints(WristConstants.kMaxVelGround, WristConstants.kMaxAccelGround))
            ...
            ,new InstantCommand(()-> p_wrist.setConstraints(WristConstants.kMaxVel, WristConstants.kMaxAccel))
