...
public class CMD_Home extends SequentialCommandGroup{
    public CMD_Home(SUB_Elevator p_elevator, SUB_Intake p_intake, SUB_Wrist p_wrist, SUB_Pivot p_pivot, SUB_Algae p_algae, GlobalVariables p_variables){
        addRequirements(p_algae, p_elevator, p_intake, p_pivot, p_wrist);
        addCommands(
