...
public class CMD_ReadyIntakeAuto extends SequentialCommandGroup{
    public CMD_ReadyIntakeAuto(SUB_Elevator p_elevator, SUB_Wrist p_wrist, SUB_Pivot p_pivot, SUB_CoralHolder p_intake){
        addCommands(
