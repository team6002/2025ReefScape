...
public class CMD_ReadyToDeployLevelTwo extends SequentialCommandGroup{
    public CMD_ReadyToDeployLevelTwo(SUB_Elevator p_elevator, SUB_Wrist p_wrist, SUB_ElevatorPivot p_elevatorPivot){
        addCommands(
            new InstantCommand(()-> p_wrist.setGoal(WristConstants.kReadyToScore))
            ,new InstantCommand(()-> p_elevatorPivot.setGoal(ElevatorPivotConstants.kDeployl2))
