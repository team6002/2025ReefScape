...
public class CMD_Algae extends Command{
    ...
    public CMD_Algae(SUB_Wrist p_wrist, SUB_ElevatorPivot p_pivot, SUB_Elevator p_elevator, SUB_Algae p_algae, 
    ...
    public void initialize(){
       if(GlobalVariables.m_haveAlgae == false){
            ...
            return;
       }else if(GlobalVariables.m_haveAlgae == false && m_variables.isRobotState(RobotState.READY_TO_INTAKE)){
            new SequentialCommandGroup(
                new InstantCommand(()-> m_variables.setRobotState(RobotState.TRANSITIONING_TO_READY))
                ,new CMD_ReadyAlgae(m_elevator, m_wrist, m_pivot, m_intake, m_algae)
                ,new InstantCommand(()-> GlobalVariables.m_haveAlgae = true)
            ...
            return;
       }else if(GlobalVariables.m_haveAlgae &! m_variables.isRobotState(RobotState.READY_TO_DEPLOY)){
            new SequentialCommandGroup(
    ...
    private SequentialCommandGroup readyToIntake(){
        ...
        switch (m_variables.getAlgaeTarget()) {
            ...
            case LEVEL_3:
                ...
                break;
            case GROUND:
                // m_readyIntakeCommand = new CMD_AlgaeIntakeGround();
                break;
            default:
                break;
        }
