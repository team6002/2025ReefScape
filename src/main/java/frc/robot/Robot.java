...
public class Robot extends LoggedRobot {
  ...
  public void robotInit() {
    ...
    // m_autonomousChooser.addOption("AUTO_TuningForwards", new AUTO_TuningForwards(m_robotContainer.m_drivetrain, m_robotContainer.m_pivot, m_robotContainer.m_flippyWrist, m_robotContainer.m_elevator, m_robotContainer.m_coralIntake, m_robotContainer.m_algae));
    // m_autonomousChooser.addOption("AUTO_TuningBackwards", new AUTO_TuningBackwards(m_robotContainer.m_drivetrain, m_robotContainer.m_pivot, m_robotContainer.m_flippyWrist, m_robotContainer.m_elevator, m_robotContainer.m_coralIntake, m_robotContainer.m_algae));
