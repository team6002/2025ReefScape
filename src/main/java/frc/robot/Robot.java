...
public class Robot extends LoggedRobot {
  ...
  public void robotInit() {
    ...
    m_autonomousChooser.addOption("AUTO_AccelTuningF", new AUTO_AccelTuningF(m_robotContainer.m_drivetrain, m_robotContainer.m_pivot, m_robotContainer.m_wrist, m_robotContainer.m_elevator, m_robotContainer.m_intake, m_robotContainer.m_algae));
    ...
    m_autonomousChooser.addOption("AUTO_WheelTuningF", new AUTO_WheelTuningForwards(m_robotContainer.m_drivetrain, m_robotContainer.m_pivot, m_robotContainer.m_wrist, m_robotContainer.m_elevator, m_robotContainer.m_intake, m_robotContainer.m_algae));
    ...
    m_autonomousChooser.addOption("AUTO_BlueLeft444", new AUTO_BlueLeft444(m_robotContainer.m_drivetrain, m_robotContainer.m_pivot, m_robotContainer.m_wrist, m_robotContainer.m_elevator, m_robotContainer.m_intake, m_robotContainer.m_algae, m_robotContainer.m_vision));
    ...
    m_autonomousChooser.addOption("AUTO_BlueRight444", new AUTO_BlueRight444(m_robotContainer.m_drivetrain, m_robotContainer.m_pivot, m_robotContainer.m_wrist, m_robotContainer.m_elevator, m_robotContainer.m_intake, m_robotContainer.m_algae, m_robotContainer.m_vision));
