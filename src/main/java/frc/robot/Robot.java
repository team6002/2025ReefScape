...
public class Robot extends LoggedRobot {
  ...
  public void robotInit() {
    ...
    // m_autonomousChooser.addOption("AUTO_SideTuning", new AUTO_SideTuning(m_robotContainer.m_drivetrain, m_robotContainer.m_pivot, m_robotContainer.m_flippyWrist, m_robotContainer.m_elevator, m_robotContainer.m_coralIntake));
    // m_autonomousChooser.addOption("AUTO_AccelTuning", new AUTO_AccelTuning(m_robotContainer.m_drivetrain, m_robotContainer.m_pivot, m_robotContainer.m_flippyWrist, m_robotContainer.m_elevator, m_robotContainer.m_coralIntake));
    ...
    // m_autonomousChooser.addOption("AUTO_AccelTuningB", new AUTO_AccelTuningB(m_robotContainer.m_drivetrain, m_robotContainer.m_pivot, m_robotContainer.m_flippyWrist, m_robotContainer.m_elevator, m_robotContainer.m_coralIntake));
    ...
    // m_autonomousChooser.addOption("AUTO_WheelTuningB", new AUTO_WheelTuningBackwards(m_robotContainer.m_drivetrain, m_robotContainer.m_pivot, m_robotContainer.m_flippyWrist, m_robotContainer.m_elevator, m_robotContainer.m_coralIntake));
    // m_autonomousChooser.addOption("AUTO_WheelTuning", new AUTO_WheelTuning(m_robotContainer.m_drivetrain, m_robotContainer.m_pivot, m_robotContainer.m_flippyWrist, m_robotContainer.m_elevator, m_robotContainer.m_coralIntake));
    // m_autonomousChooser.addOption("AUTO_Tuning", new AUTO_Tuning(m_robotContainer.m_drivetrain, m_robotContainer.m_pivot, m_robotContainer.m_flippyWrist, m_robotContainer.m_elevator, m_robotContainer.m_coralIntake));
    // m_autonomousChooser.addOption("AUTO_TuningForwards", new AUTO_TuningForwards(m_robotContainer.m_drivetrain, m_robotContainer.m_pivot, m_robotContainer.m_flippyWrist, m_robotContainer.m_elevator, m_robotContainer.m_coralIntake));
    // m_autonomousChooser.addOption("AUTO_TuningBackwards", new AUTO_TuningBackwards(m_robotContainer.m_drivetrain, m_robotContainer.m_pivot, m_robotContainer.m_flippyWrist, m_robotContainer.m_elevator, m_robotContainer.m_coralIntake));
    ...
    // m_autonomousChooser.addOption("AUTO_BlueLeft244", new AUTO_BlueLeft244(m_robotContainer.m_drivetrain, m_robotContainer.m_pivot, m_robotContainer.m_flippyWrist, m_robotContainer.m_elevator, m_robotContainer.m_coralIntake));
